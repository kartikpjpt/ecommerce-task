...
export function ProductCard({ product, isFavorite, onToggleFavorite, observerRef }: ProductCardProps) {
    return (
        <div ref={observerRef} className='bg-card group overflow-hidden rounded-sm border transition-shadow hover:shadow-lg'>
            ...
            <div className='p-4'>
                ...
                <div className='mb-2 flex items-center gap-1.5'>
                    ...
                    <span className='text-xs font-medium capitalize text-muted-foreground'>{product.category}</span>
                </div>
